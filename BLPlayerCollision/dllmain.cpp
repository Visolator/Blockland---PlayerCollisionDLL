...
bool Init()
{
	...
	PlayerMoveMask = (int*)0x71AA70; // old 0x71A9B0
	PlayerCollisionMaskServer = (int*)0x71AA6C; // old 0x71AA6C
	PlayerCollisionMaskClient = (int*)0x71AA70; // old 0x71AA70
	VehicleCollisionMask = (int*)0x71D3E4; // old 0x71D3E4
